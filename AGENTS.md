...
| --- | --- | --- | --- | --- |
| AI Engineer | yes / no | passed / pending / failed / not required | proof or review link, or `—` | clear summary of the reviewer's finding and advice |
| Solution Architect | yes / no | passed / pending / failed / not required | proof or review link, or `—` | clear summary of the reviewer's finding and advice |
| Senior Developer | yes / no | passed / pending / failed / not required | proof or review link, or `—` | clear summary of the reviewer's finding and advice |
...
- State `pending`, `failed`, or `not required` plainly. In every row, summarise
  what that reviewer found or advised; explain the smallest next action for
  anything not passed.
