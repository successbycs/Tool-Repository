...
| 2 | `ollama-readiness` | `cs-ai-lab-infra/ollama/` and `CSP-Directory/scripts/check_ollama_models.py` | **Clean-room candidate.** Model listing and readiness only; no model pull or runtime reconfiguration by default. |
