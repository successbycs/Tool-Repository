...
class TargetOperatingModelTests(unittest.TestCase):
    def test_capability_status_rows_match_the_registry(self) -> None:
        ...
        self.assertEqual(mapped, {"TR-M00", "TR-M01A", "TR-M04", "TR-M06", "TR-M09", "TR-M10", "TR-M11", "TR-M12", "TR-M14", "TR-M15", "TR-M16", "TR-M17", "TR-M18", "TR-M19", "TR-M20", "TR-M21", "TR-M22", "TR-M23", "TR-M24", "TR-M25", "TR-M26"})
